...
public class WorkingSatMaxDailyReductionElaboration extends MaxDailyMeanReductionElaboration {

	public static final String ID = "reductionmaxworkdaysaturday";

	public WorkingSatMaxDailyReductionElaboration(String name) {
		super(name);
	}
